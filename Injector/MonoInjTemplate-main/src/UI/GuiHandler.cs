...
namespace MonoInjectionTemplate.UI
{
    public class GuiHandler : MonoBehaviour
    {
        ...
        private float someFloat1;
        private float someFloat2;
        ...
        public void Start()
        {
            ...
            _window1.AddSlider("Slider 1",0,10, x => someFloat1 = x, 3);
            _window1.AddSlider("Slider, thresh 2f", 2,100, x => someFloat2 = x,18,2.0f);
